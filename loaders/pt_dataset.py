...
def collate_fn_turl(samples):
    ...
    assert len(label) == cls_idx.shape[0]
...
class CTATestDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for col in table[row_nos,:][:,col_nos].T:
...
# exclude_cpa_tables = ['34435695-9', '39366987-1', '24868131-1', '33047453-1', '33047456-1', '3973178-1']

exclude_cpa_tables = ['34435695-9', '39366987-1', '24868131-1', '24528524-5', '165522-2', '35312655-39', '2026278-1', '2026278-13',
 '2026278-2', '2026278-20', '576240-1', '18983113-2', '6613945-1', '1310083-1', '730672-1', '17572552-1', '720599-1',
 '6333010-3', '7901858-1', '8699747-2', '8699966-5', '10103526-1', '1345281-1', '4512004-1', '25953966-4', '25954090-2',
 '24075060-1', '7550768-1', '11596136-1', '6929260-1', '13844094-1', '11270280-6', '6958963-5', '7088460-2',
 '4161450-1', '728282-1', '728369-1', '15050895-7', '65976-10', '28270498-4', '39491121-1', '735074-6', '13052333-1',
 '2509109-1', '7166881-1', '33047441-1', '33047449-1', '33047459-1', '33047462-1', '33047469-1', '33047472-1',
 '33047482-1', '33047484-1', '33047487-1', '33047489-1', '33047490-1', '36805276-1', '2004786-1', '644982-1',
 '6232685-2', '6246509-2', '32374296-17'] + ['33047453-1', '33047456-1', '3973178-1']
...
class CPADataset(Dataset):
    ...
    def generate_epoch(self):
        ...
        for tbname, data in self.data_dict.items():
            ...
            # wikitable-turl
            if tbname in exclude_cpa_tables:
                continue
...
if __name__ == "__main__":
    ...
    filename1 = os.path.join(dataset_path, 'CTA-DBP.pkl')
    filename2 = os.path.join(dataset_path, 'cta.pkl')
    ...
    filename1 = os.path.join(dataset_path, 'CPA-DBP.pkl')
    filename2 = os.path.join(dataset_path, 'cpa.pkl')
    data_dict = load(filename1)
    table_dict = load(filename2)

    test_cpa('train', data_dict, table_dict)
    test_cpa('validation', data_dict, table_dict)
