...
def inference():
    ...
    # hard coded -> line 85,86 ->  TODO -> update model names
    ...
    for k, (task, valid_dataset, test_dataset, valid_dataloader,
        ...
        if args.shortcut_name in [ 'Qwen/Qwen3-Embedding-0.6B', 'Qwen/Qwen3-Embedding-4B', 'Qwen/Qwen3-Embedding-8B']:
            ...
            # TODO
            model_filename = "{}={}_marco_cta1_1cpa1_2_400.pt".format(tag_name, task)
            model_g_filename = "{}={}_G_marco_cta1_1cpa1_2_400.pt".format(tag_name, task)
            ...
            if args.merge_lora:
                ...
                model_save_filename = "{}={}_mirco_cta1_1cpa1_2_0717_3_merged.pt".format(tag_name, task)
                torch.save(model.state_dict(), os.path.join(args.model_save_path, model_save_filename))
        else:
        ...
        for iter in range(iteration):
            ...
            test_dataset.data_list = test_dataset.data_list[10:]
            ...
            if 'CTA' in task:
                ...
                if write:
                    ...
                    target_file = 'CTA_SCH_TEST_GT_CSV'
                    result_path = args.result_path
                    save_file = 'cta_sch_test_{}.csv'.format(iter)
            ...
            if 'CPA' in task:
                ...
                if write:
                    target_path = 'SOTAB_DATASET_FOLDER_PATH'
                    target_file = 'CPA_SCH_TEST_GT_CSV'
                    result_path = args.result_path
                    save_file = 'cpa_sch_test_{}.csv'.format(_iter)
                    with open(os.path.join(target_path, target_file), 'r') as fr:
                        with open(os.path.join(result_path, save_file), 'w') as fw:
                            for i, line in enumerate(fr.readlines()):
                                line = line.strip()
